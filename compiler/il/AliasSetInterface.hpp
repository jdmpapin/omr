...
public:
    ...
    TR_AliasSetInterface(bool shares_symbol, TR::SymbolReference *symRef, bool isDirectCall = false,
...
private:
    static void removeSymRef1KillsSymRef2Asymmetrically(TR::SymbolReference *symRef1, TR::SymbolReference *symRef2,
        bool includeGCSafePoint);
    static void addSymRef1KillsSymRef2Asymmetrically(TR::SymbolReference *symRef1, TR::SymbolReference *symRef2,
        bool includeGCSafePoint);
    static void setSymRef1KillsSymRef2Asymmetrically(TR::SymbolReference *symRef1, TR::SymbolReference *symRef2,
...
template<>
inline TR_BitVector *TR_AliasSetInterface<UseOnlyAliasSet>::getTRAliases_impl(bool isDirectCall,
    bool includeGCSafePoint)
{
    if (!_symbolReference)
...
inline void TR_AliasSetInterface<_AliasSetInterface>::setAlias_impl(TR::SymbolReference *symRef2, bool value,
...
template<AliasSetInterface _AliasSetInterface>
inline void TR_AliasSetInterface<_AliasSetInterface>::addSymRef1KillsSymRef2Asymmetrically(TR::SymbolReference *symRef1,
    TR::SymbolReference *symRef2, bool includeGCSafePoint)
{
    TR::Compilation *comp = TR::comp();
    TR_BitVector *symRef1_killedAliases = symRef1->getUseDefAliases(includeGCSafePoint).getTRAliases();
...
template<AliasSetInterface _AliasSetInterface>
inline void TR_AliasSetInterface<_AliasSetInterface>::setSymRef1KillsSymRef2Asymmetrically(TR::SymbolReference *symRef1,
    TR::SymbolReference *symRef2, bool includeGCSafePoint, bool value)
{
    TR::Compilation *comp = TR::comp();
